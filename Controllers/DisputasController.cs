...
namespace RpgMvc.Controllers
{
    ...
    {
         public string uriBase = "http://CarlosKauan.somee.com/RpgApi/Disputas/";
        //xyz será substituido pelo nome do seu site na API

        //Metodos Ficaram Aqui !
        [HttpGet]
        public async Task<ActionResult> IndexAsync()
        {
            try
            {
                ...
                string uriBuscaPersonagens = "http://CarlosKauan.somee.com/RpgApi/Personagens/GetAll";                
        ...
        //Método que realizará a postagem do ataque com armas para a API.
        [HttpPost]
       ...
       [HttpGet]
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                string uriBuscaHabilidades = "http://CarlosKauan.somee.com/RpgApi/PersonagemHabilidades/GetHabilidade";               
        ...
        //Método Post enviará a disputa para a API. 
        [HttpPost]
        ...
        public async Task<ActionResult> DisputaGeralAsync()
        {
            try
            {
                ...
                string uriDisputa = "http://CarlosKauan.somee.com/RpgApi/Disputas/DisputaEmGrupo";
